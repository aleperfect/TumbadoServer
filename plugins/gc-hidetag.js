...
**/
    ...
    const htextos = `${text ? text : '*𝐁𝐎𝐓𝐂𝐈𝐓𝐎 TUMBADO*'}`;
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://www.instagram.com/ancelzzz'}}}}}, {});
    }
  }
};
handler.command = /^(hidetag|notificar|notify|noti|llamar)$/i;
handler.group = true;
handler.admin = true;
